...
cm.class: absyn/*.java Patcher/*.java SymbolTable/*.java parser.java sym.java Lexer.java cm.java
...
clean:
	rm -f parser.java Lexer.java sym.java *.class absyn/*.class *~ Patcher/*.class SymbolTable/*.class AssemblyGen/*.class *~ tm *.asm
